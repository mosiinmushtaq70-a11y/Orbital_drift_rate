...
for e in eccentricities:
    ...
    plt.title(f"Fractional Energy Error e={e}")
...
df.to_csv(os.path.join(data_path, "euler_summary.csv"), index=False)

print("All Euler runs completed successfully.")