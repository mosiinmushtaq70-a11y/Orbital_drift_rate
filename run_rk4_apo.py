...
for e in eccentricities:
    ...
    print(f"Running RK4 (Apoapsis) for e = {e}")
    ...
    plt.title(f"RK4 Apo Fractional Energy Error e={e}")
...
df.to_csv(os.path.join(data_path, "rk4_apo_summary.csv"), index=False)

print("RK4 Apo complete with full structure.")